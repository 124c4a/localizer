...
// #region example
import { IdentityLocalizer, loc } from '@localizer/core';
import { decimal } from '@localizer/format';
import { dictionary, plural } from '@localizer/translate';
import { zero, one, two, few, many, other } from '@localizer/translate';
...
console.log(IdentityLocalizer(twentyOneFiles));
console.log(IdentityLocalizer(decimal(42)));
// #endregion example
